...
const StatusDisplay = () => {
      ...
      case "Pending":
        return (
          <>
            ...
            <p className="text-xl text-gray-200">
              Your payment is being processed. We will notify you upon
              confirmation.
            </p>
          </>
        );
  ...
  return (
    <div className="min-h-screen bg-[#0d0d1a] text-white flex flex-col items-center justify-center text-center p-4">
      ...
      <Link
        href="/"
        className="mt-8 bg-[#e97bfc] text-black font-bold py-3 px-6 rounded-lg text-lg hover:bg-[#f8c8fc] transition-colors duration-300"
      >
        Back to Home
      </Link>
    </div>
